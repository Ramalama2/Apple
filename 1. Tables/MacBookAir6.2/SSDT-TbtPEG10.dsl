 ...
 * 
 * Disassembly of AML/SSDT-TbtPEG10.aml, Mon Jan  6 22:30:13 2014
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x0000534A (21322)
 *     Revision         0x01
 *     Checksum         0xAA
 *     OEM ID           "Apple"
...
DefinitionBlock ("AML/SSDT-TbtPEG10.aml", "SSDT", 1, "Apple", "TbtPEG10", 0x00001000)
{
    ...
    Scope (\_SB.PCI0)
    {
        ...
        Method (RMCR, 0, Serialized)
        {
            If (LNot (OSDW))
            {
                ...
                If (LAnd (LEqual (\_SB.PCI0.P0P2.UPSB.DSB1.UPS0.AVND, 0xFFFF), LEqual (\_SB.PCI0.P0P2.UPSB.DSB2.UPS0.AVND, 0xFFFF)))
                {
                    RMC1 ()
                    Return (Zero)
                }
