 ...
 * 
 * Disassembly of AML/SSDT-SDUsbLpt.aml, Mon Jan  6 23:23:50 2014
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00001152 (4434)
 *     Revision         0x01
 *     Checksum         0xB3
 *     OEM ID           "Apple"
...
DefinitionBlock ("AML/SSDT-SDUsbLpt.aml", "SSDT", 1, "Apple", "SDUsbLpt", 0x00001000)
{
        ...
        Device (XHC1)
        {
            ...
            Method (LEGM, 0, NotSerialized)
            {
                If (LNot (OSDW))
                {
                    XHCA ()
                    XHCB ()
                    Store (0x7B, \_SB.PCI0.XHC1.PND0)
                    Store (0x03, \_SB.PCI0.XHC1.PND8)
                }
            }

            OperationRegion (XHCX, SystemMemory, 0xE00A0000, 0xC0)
            Field (XHCX, DWordAcc, Lock, Preserve)
            {
                Offset (0x04), 
                PDBM,   16, 
                Offset (0x10), 
